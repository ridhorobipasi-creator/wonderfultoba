...
>
    ...
    <div class="relative overflow-hidden bg-slate-900 pt-32 pb-20 px-6 md:px-8">
        ...
        <div class="relative z-10 max-w-7xl mx-auto text-center">
            <span class="inline-flex items-center gap-2 px-4 py-1.5 bg-toba-green/20 text-toba-accent text-[10px] font-black uppercase tracking-[0.3em] rounded-full mb-5">
            ...
            <article class="group bg-white rounded-[2rem] overflow-hidden shadow-sm border border-slate-100 hover:shadow-2xl transition-all duration-500 mb-10 md:flex">
                <div class="relative md:w-1/2 h-64 md:h-auto overflow-hidden">
                    ...
                    <div class="absolute top-5 left-5">
                        <span class="bg-toba-green text-white px-4 py-1.5 rounded-xl text-[10px] font-black uppercase tracking-wider shadow-lg" x-text="featured.category"></span>
                    </div>
                </div>
