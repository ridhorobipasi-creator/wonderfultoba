        ...
        <div class="bg-white rounded-[3rem] p-8 md:p-16 shadow-sm border border-slate-100">
            ...
            <div class="prose prose-slate max-w-none font-medium text-slate-600 leading-relaxed">
                ...
                @else
                    ...
                    <p class="mb-6">Pelunasan wajib dilakukan paling lambat 7 hari sebelum tanggal keberangkatan. Pembayaran dilakukan melalui transfer bank ke rekening resmi PT Wonderful Toba Experience.</p>
