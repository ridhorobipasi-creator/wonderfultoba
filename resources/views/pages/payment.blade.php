...
<div class="bg-slate-50 min-h-screen pt-32 pb-24">
    <div class="max-w-5xl mx-auto px-6 md:px-8 animate-in fade-in slide-in-from-bottom-8 duration-1000">
        ...
        <div class="text-center mb-16">
            <span class="inline-flex items-center gap-2 px-3 py-1 bg-toba-green/10 border border-toba-green/20 text-toba-green text-[10px] font-semibold uppercase tracking-[0.2em] rounded-full">{{ __('Informasi') }}</span>
            <h1 class="text-3xl md:text-5xl font-light text-slate-900 tracking-tight mt-6">
                {{ __('Cara') }} <span class="text-toba-green">{{ __('Pembayaran') }}</span>
            </h1>
            <p class="mt-4 text-slate-500 font-normal max-w-xl mx-auto text-sm leading-relaxed">
        ...
        {{-- Deposit Info --}}
        <div class="bg-white border border-slate-100 rounded-3xl p-6 md:p-8 mb-12 flex gap-5 items-start shadow-sm">
            <div class="w-10 h-10 bg-toba-green/10 text-toba-green rounded-xl flex items-center justify-center shrink-0">
                <i class="fas fa-info text-sm"></i>
            </div>
            <div>
                <h3 class="text-slate-900 font-bold text-base mb-1.5">Sistem Deposit / Booking Confirmation</h3>
        ...
        <div class="mb-12">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div class="bg-white border border-slate-100 rounded-3xl p-6 text-center shadow-sm hover:border-toba-green/30 transition-all duration-300">
                    <div class="text-3xl mb-3">🇲🇾</div>
                    <p class="font-bold text-slate-900 text-lg">MYR</p>
                    <p class="text-slate-400 text-xs font-normal mt-0.5">Ringgit Malaysia</p>
                    <p class="text-toba-green font-bold text-xs tracking-wider mt-3">✓ Diterima</p>
                </div>
                <div class="bg-white border border-slate-100 rounded-3xl p-6 text-center shadow-sm hover:border-toba-green/30 transition-all duration-300">
                    <div class="text-3xl mb-3">🇸🇬</div>
                    <p class="font-bold text-slate-900 text-lg">SGD</p>
                    <p class="text-slate-400 text-xs font-normal mt-0.5">Singapore Dollar</p>
                    <p class="text-toba-green font-bold text-xs tracking-wider mt-3">✓ Diterima</p>
                </div>
                <div class="bg-white border border-slate-100 rounded-3xl p-6 text-center shadow-sm hover:border-toba-green/30 transition-all duration-300">
                    <div class="text-3xl mb-3">🇮🇩</div>
                    <p class="font-bold text-slate-900 text-lg">IDR</p>
        ...
        <div class="mb-12">
            ...
            <div class="space-y-6">
                ...
                {{-- Wise --}}
                <div class="bg-white border border-slate-100 rounded-3xl p-6 md:p-8 shadow-sm hover:border-toba-green/20 transition-all duration-300">
                    <div class="flex items-start gap-5">
                        ...
                        <div>
                            <h3 class="font-bold text-slate-900 text-base mb-1.5">Wise (TransferWise) — <span class="text-toba-green font-medium">Rekomendasi untuk Tamu Internasional</span></h3>
                            ...
                            <div class="mt-4 bg-slate-50 border border-slate-100 rounded-2xl p-4 text-xs font-normal text-slate-600">
                ...
                <div class="bg-white border border-slate-100 rounded-3xl p-6 md:p-8 shadow-sm hover:border-toba-green/20 transition-all duration-300">
                    <div class="flex items-start gap-5">
                        ...
                        <div>
                            <h3 class="font-bold text-slate-900 text-base mb-1.5">Transfer Bank Internasional (SWIFT)</h3>
        ...
        <div class="mb-12" x-data="{ open: null }">
            ...
            <div class="space-y-4">
                ...
                <div class="bg-white border border-slate-100 rounded-3xl overflow-hidden shadow-sm">
                    <button @click="open = open === {{ $i }} ? null : {{ $i }}" class="w-full flex items-center justify-between p-5 text-left font-bold text-sm text-slate-900 hover:text-toba-green transition-colors outline-none">
                        <span>{{ $faq['q'] }}</span>
                        <svg class="w-4 h-4 shrink-0 ml-4 transition-transform text-slate-400" :class="open === {{ $i }} ? 'rotate-180 text-toba-green' : ''" fill="none" stroke="currentColor" stroke-width="3" viewBox="0 0 24 24"><path d="M19 9l-7 7-7-7"/></svg>
                    </button>
        ...
        {{-- CTA --}}
        <div class="bg-slate-950 rounded-3xl p-8 md:p-12 text-center shadow-sm border border-slate-900">
            <h3 class="text-2xl md:text-3xl font-light text-white mb-3">Siap Memesan? / Ready to Book?</h3>
            <p class="text-slate-400 font-normal text-sm mb-8">Hubungi kami via WhatsApp dan kami akan panduan proses pembayaran step-by-step.</p>
            <a href="https://wa.me/6281323888207" target="_blank" class="inline-flex items-center gap-3 bg-toba-green text-white px-8 py-3.5 rounded-xl font-bold text-xs uppercase tracking-wider hover:bg-white hover:text-slate-900 transition-all shadow-sm">
