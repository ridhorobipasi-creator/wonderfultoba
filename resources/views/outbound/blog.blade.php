...
@section('title', 'Blog & Dokumentasi Outbound – Wonderful Toba')
@section('description', 'Cerita seru, tips teambuilding, dan dokumentasi event outbound Wonderful Toba.')
    ...
    x-data="{ 
        ...
        get filteredPosts() {
            return this.posts.filter(p => {
                return p.title.toLowerCase().includes(this.searchQuery.toLowerCase()) || 
...
>
    ...
    <div class="relative overflow-hidden bg-slate-900 pt-32 pb-20 px-4">
        ...
        <div class="relative z-10 max-w-7xl mx-auto text-center">
            ...
            <h1 class="text-4xl md:text-6xl font-black text-white mb-5 tracking-tight">
                Dokumentasi <span class="text-toba-green">Event</span>
            </h1>
            <p class="text-slate-300 text-lg max-w-2xl mx-auto font-medium leading-relaxed mb-8">
                Cerita seru, tips team building, dan inspirasi untuk event perusahaan Anda selanjutnya.
            </p>
            <!-- Search -->
            <div class="max-w-lg mx-auto relative">
                ...
                <input
                    type="text"
                    placeholder="Cari artikel outbound..."
                    x-model="searchQuery"
    ...
    <div class="max-w-7xl mx-auto px-4 mt-12">
        <div x-show="filteredPosts.length === 0" class="text-center py-24 bg-white rounded-[2rem] border border-slate-100">
            ...
            <p class="text-slate-400">Coba kata kunci lain.</p>
        </div>
