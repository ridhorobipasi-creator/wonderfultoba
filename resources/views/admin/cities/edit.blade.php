...
@section('page-title', 'Edit City: ' . $city->name)
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <textarea name="description" rows="5"
                        class="w-full px-6 py-4 bg-gray-50 border border-gray-100 rounded-2xl focus:ring-4 focus:ring-toba-green/10 focus:border-toba-green transition font-medium text-gray-700">{{ old('description', $city->description) }}</textarea>
                </div>
