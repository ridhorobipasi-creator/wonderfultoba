...
<div class="max-w-4xl">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
        <h2 class="text-2xl font-black text-gray-900 mb-6">Add New Car</h2>
        ...
        <form action="{{ route('admin.cars.store') }}" method="POST">
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" required placeholder="e.g., Toyota Avanza 2023"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="type" value="{{ old('type') }}" required placeholder="e.g., MPV, SUV, Sedan"
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div>
                        ...
                        <input type="number" name="capacity" value="{{ old('capacity') }}" required min="1" placeholder="7"
                    ...
                    <div>
                        ...
                        <input type="text" name="fuel" value="{{ old('fuel') }}" required placeholder="e.g., Petrol, Diesel"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <span class="absolute left-4 top-1/2 -translate-y-1/2 text-gray-500 font-semibold">Rp</span>
                            <input type="number" name="priceWithDriver" value="{{ old('priceWithDriver') }}" min="0" step="1000"
