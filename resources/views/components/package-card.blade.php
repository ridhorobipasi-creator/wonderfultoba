...
<div class="card-flat overflow-hidden hover:shadow-md transition-all duration-300 group flex flex-col h-full">
    ...
    <div class="p-6 md:p-8 flex flex-col flex-grow">
        ...
        <div class="flex items-center justify-between pt-6 border-t border-slate-50 mt-auto">
            ...
            <a
                ...
                class="w-12 h-12 md:w-14 md:h-14 bg-slate-900 text-white rounded-2xl flex items-center justify-center hover:bg-slate-800 transition-all shadow-sm group/btn"
            >
