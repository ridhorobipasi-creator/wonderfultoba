...
class CustomerBookingNotification extends Notification
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        $packageUrl = $this->booking->package?->slug
            ? route('tour.package.detail', $this->booking->package->slug)
            : route('tour.packages');
        ...
        return (new MailMessage)
                    ...
                    ->line('Terima kasih telah memilih Sujailake Toba untuk rencana perjalanan Anda.')
