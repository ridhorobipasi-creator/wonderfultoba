...
<head>
    ...
    <title>Maintenance - Sujailake Toba</title>
...
<body class="bg-slate-50 flex items-center justify-center min-h-screen p-6">
    <div class="max-w-xl w-full text-center space-y-10">
        ...
        <div class="space-y-4">
            ...
            <p class="text-slate-500 font-bold leading-relaxed">Sujailake Toba sedang melakukan pemeliharaan rutin untuk meningkatkan pengalaman perjalanan Anda. Kami akan segera kembali!</p>
        </div>
        ...
        <div class="bg-white p-8 rounded-[2rem] border border-slate-100 shadow-sm flex flex-col items-center">
            ...
            <a href="https://wa.me/628123456789" class="inline-flex items-center gap-3 px-8 py-4 bg-lake-blue text-white rounded-2xl font-black text-xs uppercase tracking-widest hover:bg-lake-mid transition shadow-xl shadow-blue-100">
                <i class="fab fa-whatsapp"></i> Hubungi WhatsApp
            </a>
        </div>

        <p class="text-[9px] font-black text-slate-300 uppercase tracking-[0.4em]">Sujailake Toba &bull; Management v3.0</p>
    </div>
