...
@section('title', ($package->name ?? 'Paket Wisata') . ' – Sujailake Toba')
...
>
    ...
    <div class="relative h-[75dvh] w-full overflow-hidden bg-slate-900">
        ...
        <div class="relative z-10 h-full max-w-7xl mx-auto px-6 md:px-8 flex flex-col justify-center">
            <div class="max-w-4xl animate-in fade-in slide-in-from-left-12 duration-1000">
                <a href="/packages" class="inline-flex items-center gap-3 text-white/80 hover:text-white font-black text-[10px] uppercase tracking-[0.4em] mb-10 transition-all group">
                    <div class="w-10 h-10 rounded-full bg-white/10 backdrop-blur-md flex items-center justify-center border border-white/20 group-hover:bg-lake-blue group-hover:border-lake-blue transition-all">
                ...
                <div class="flex items-center gap-3 mb-6">
                    <span class="px-4 py-1.5 bg-lake-blue text-white rounded-full text-[10px] font-black uppercase tracking-widest shadow-lg shadow-lake-blue/30" x-text="package.status === 'active' ? 'Paket Tersedia' : 'Coming Soon'"></span>
                    <span class="px-4 py-1.5 bg-white/10 backdrop-blur-md border border-white/20 text-lake-light rounded-full text-[10px] font-black uppercase tracking-widest" x-text="locationDisplay"></span>
                </div>
                ...
                <div class="flex flex-wrap items-center gap-10">
                    <div class="flex flex-col">
                        ...
                        <div class="flex items-center gap-2 text-white font-black text-2xl tracking-tight">
                            <svg class="w-6 h-6 text-lake-blue" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"/><path d="M12 6v6l4 2"/></svg>
                    ...
                    <div class="flex flex-col">
                        ...
                        <div class="flex items-baseline gap-1 text-white font-black text-3xl tracking-tighter">
                            <span x-text="formatPrice(package.price)"></span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20">
            ...
            <div class="lg:col-span-8 space-y-20">
                ...
                <div x-show="package_images && package_images.length > 1" class="flex flex-wrap gap-4 animate-in fade-in zoom-in duration-1000">
                    <template x-for="(imgObj, i) in package_images" :key="i">
                        <button @click="activeImg = i"
                            :class="activeImg === i ? 'ring-4 ring-lake-blue scale-105 shadow-2xl' : 'opacity-70 hover:opacity-100 border-2 border-white'"
                ...
                <div id="booking-form" class="relative group bg-white rounded-[3.5rem] shadow-[0_40px_100px_-20px_rgba(15,23,42,0.1)] border border-slate-100 animate-in fade-in slide-in-from-bottom-12 duration-1000 p-8 md:p-14 lg:p-16 overflow-hidden">
                    ...
                    <div class="absolute top-0 right-0 w-[800px] h-[800px] bg-lake-blue/5 rounded-full blur-[120px] -mr-[400px] -mt-[400px] pointer-events-none"></div>

                    <div class="relative z-10 mb-14 flex flex-col items-center text-center">
                        <div class="inline-flex items-center gap-3 px-5 py-2.5 bg-lake-blue/10 text-lake-blue rounded-full mb-8 border border-lake-blue/20">
                            <div class="w-2 h-2 bg-lake-blue rounded-full animate-pulse"></div>
                        ...
                        <h3 class="text-4xl md:text-5xl font-black text-slate-900 tracking-tighter leading-tight mb-4">
                            Lengkapi Data <span class="text-lake-blue">Perjalanan Anda</span>
                        </h3>
                    ...
                    @if(session('success'))
                        <div class="py-16 px-8 bg-emerald-50/50 rounded-[3rem] border border-emerald-100 text-center animate-in zoom-in duration-1000">
                            ...
                            <p class="text-slate-500 font-medium mb-12 max-w-sm mx-auto text-base">Kami telah mengirimkan detail pesanan. Silakan simpan kode referensi Anda.</p>
                            ...
                            <div class="max-w-md mx-auto">
                                <a 
                                    :href="'https://wa.me/' + waNumber + '?text=' + encodeURIComponent('Halo Sujailake Toba,\n\nSaya baru saja melakukan booking di website.\n\n*Detail Pesanan:*\nKode: {{ session('bookingCode') }}\nPaket: ' + package.name + '\n\nMohon bantuannya untuk proses selanjutnya. Terima kasih!')"
                                    target="_blank"
                            ...
                            <div class="space-y-4 md:col-span-2">
                                ...
                                <div class="relative">
                                    <input type="text" name="customerName" required value="{{ old('customerName') }}" placeholder="Masukkan nama lengkap" 
                                        class="w-full px-8 py-6 bg-slate-50 hover:bg-slate-100 focus:bg-white border-2 {{ $errors->has('customerName') ? 'border-red-500' : 'border-slate-100' }} focus:border-lake-blue rounded-3xl outline-none font-bold text-slate-900 text-lg transition-all shadow-sm focus:shadow-xl focus:shadow-lake-blue/10 placeholder:text-slate-300 placeholder:font-medium">
                                </div>
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="relative">
                                    <input type="email" name="customerEmail" required value="{{ old('customerEmail') }}" placeholder="email@contoh.com" 
                                        class="w-full px-8 py-6 bg-slate-50 hover:bg-slate-100 focus:bg-white border-2 {{ $errors->has('customerEmail') ? 'border-red-500' : 'border-slate-100' }} focus:border-lake-blue rounded-3xl outline-none font-bold text-slate-900 text-lg transition-all shadow-sm focus:shadow-xl focus:shadow-lake-blue/10 placeholder:text-slate-300 placeholder:font-medium">
                                </div>
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="relative">
                                    <input type="tel" name="customerPhone" required value="{{ old('customerPhone') }}" placeholder="0812-xxxx-xxxx" 
                                        class="w-full px-8 py-6 bg-slate-50 hover:bg-slate-100 focus:bg-white border-2 {{ $errors->has('customerPhone') ? 'border-red-500' : 'border-slate-100' }} focus:border-lake-blue rounded-3xl outline-none font-bold text-slate-900 text-lg transition-all shadow-sm focus:shadow-xl focus:shadow-lake-blue/10 placeholder:text-slate-300 placeholder:font-medium">
                                </div>
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="relative">
                                    <input type="date" name="startDate" required value="{{ old('startDate') }}" 
                                        class="w-full px-8 py-6 bg-slate-50 hover:bg-slate-100 focus:bg-white border-2 {{ $errors->has('startDate') ? 'border-red-500' : 'border-slate-100' }} focus:border-lake-blue rounded-3xl outline-none font-bold text-slate-900 text-lg transition-all shadow-sm focus:shadow-xl focus:shadow-lake-blue/10 uppercase">
                                </div>
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="relative">
                                    <input type="number" name="pax" required min="1" value="{{ old('pax') }}" placeholder="Jumlah orang" 
                                        class="w-full px-8 py-6 bg-slate-50 hover:bg-slate-100 focus:bg-white border-2 {{ $errors->has('pax') ? 'border-red-500' : 'border-slate-100' }} focus:border-lake-blue rounded-3xl outline-none font-bold text-slate-900 text-lg transition-all shadow-sm focus:shadow-xl focus:shadow-lake-blue/10 placeholder:text-slate-300 placeholder:font-medium">
                            ...
                            <div class="space-y-4 md:col-span-2">
                                ...
                                <div class="relative">
                                    <textarea name="notes" placeholder="Misal: Permintaan hotel khusus, alergi makanan, layanan penjemputan bandara, dll." rows="3"
                                        class="w-full px-8 py-6 bg-slate-50 hover:bg-slate-100 focus:bg-white border-2 {{ $errors->has('notes') ? 'border-red-500' : 'border-slate-100' }} focus:border-lake-blue rounded-3xl outline-none font-bold text-slate-900 text-lg transition-all shadow-sm focus:shadow-xl focus:shadow-lake-blue/10 placeholder:text-slate-300 placeholder:font-medium resize-none leading-relaxed">{{ old('notes') }}</textarea>
                                </div>
                        ...
                        <div class="max-w-2xl mx-auto pt-4">
                            ...
                            >
                                ...
                                <div x-show="!isSubmitting" class="relative z-10 flex items-center justify-center gap-6 w-full px-10">
                                    ...
                                    <div class="w-14 h-14 bg-white/10 rounded-full flex items-center justify-center group-hover:bg-white group-hover:text-lake-blue transition-all duration-500 group-hover:translate-x-4 shadow-sm">
                                        <svg class="w-6 h-6" fill="none" stroke="currentColor" stroke-width="3" viewBox="0 0 24 24"><path d="M5 12h14M12 5l7 7-7 7"/></svg>
                                    </div>
                                </div>

                                <span x-show="isSubmitting" class="flex items-center gap-4 relative z-10 text-lake-blue bg-slate-900/50 backdrop-blur-sm w-full h-full justify-center">
                    ...
                    <div class="mt-16 pt-12 border-t border-slate-100">
                        <h4 class="text-center text-[10px] font-black uppercase tracking-[0.4em] text-slate-400 mb-8">Eksklusivitas Sujailake Toba</h4>
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
                            <div class="flex flex-col items-center group">
                                <div class="w-16 h-16 rounded-3xl bg-slate-50 border border-slate-100 flex items-center justify-center text-lake-blue mb-5 group-hover:bg-lake-blue group-hover:text-white transition-all shadow-sm">
                ...
                <div class="mt-20 border-b border-slate-100 overflow-x-auto no-scrollbar mb-14">
                    <div class="flex gap-12">
                        <button @click="activeTab = 'itinerary'" 
                            :class="activeTab === 'itinerary' ? 'text-lake-blue border-b-4 border-lake-blue pb-6' : 'text-slate-400 hover:text-slate-600 pb-6'"
                        ...
                        <button @click="activeTab = 'pricing'" 
                            :class="activeTab === 'pricing' ? 'text-lake-blue border-b-4 border-lake-blue pb-6' : 'text-slate-400 hover:text-slate-600 pb-6'"
                            class="text-[10px] font-black uppercase tracking-[0.4em] transition-all whitespace-nowrap flex items-center gap-3">
                            <i class="fas fa-tags text-sm"></i>
                            BIAYA & FASILITAS
                        </button>
                        <button @click="activeTab = 'reviews'" 
                            :class="activeTab === 'reviews' ? 'text-lake-blue border-b-4 border-lake-blue pb-6' : 'text-slate-400 hover:text-slate-600 pb-6'"
                            class="text-[10px] font-black uppercase tracking-[0.4em] transition-all whitespace-nowrap flex items-center gap-3">
                ...
                <div x-show="activeTab === 'itinerary'" x-transition:enter="transition ease-out duration-500" x-transition:enter-start="opacity-0 translate-y-8" x-transition:enter-end="opacity-100 translate-y-0" class="space-y-20">
                    ...
                    <div class="bg-white rounded-[3rem] p-10 md:p-14 shadow-[0_40px_80px_-20px_rgba(15,23,42,0.08)] border border-slate-50">
                        <div class="flex items-center space-x-3 mb-8">
                            <div class="h-1.5 w-12 bg-lake-blue rounded-full"></div>
                            <span class="text-lake-blue font-black text-xs uppercase tracking-[0.4em]">Tentang Paket</span>
                        </div>
                        <h2 class="text-3xl md:text-4xl font-black text-slate-900 mb-8 tracking-tight">Ringkasan <span class="text-lake-blue">Pengalaman</span></h2>
                    ...
                    <div x-show="package.itinerary || package.itineraryText" class="relative">
                        <div class="flex items-center space-x-3 mb-12">
                            <div class="h-1.5 w-12 bg-lake-blue rounded-full"></div>
                            <span class="text-lake-blue font-black text-xs uppercase tracking-[0.4em]">Agenda Perjalanan</span>
                        </div>
                        ...
                        <div x-show="!package.itineraryText && package.itinerary" class="space-y-12 relative">
                            <!-- Vertical line -->
                            <div class="absolute left-[31px] top-10 bottom-10 w-1.5 bg-gradient-to-b from-lake-blue via-emerald-100 to-transparent rounded-full hidden md:block"></div>
                            
                            <template x-for="(day, i) in package.itinerary" :key="i">
                                <div class="relative pl-0 md:pl-20 group">
                                    <!-- Indicator -->
                                    <div class="absolute left-0 top-0 w-16 h-16 rounded-3xl bg-slate-900 text-white flex flex-col items-center justify-center shadow-2xl z-10 transition-transform duration-500 group-hover:scale-110 group-hover:bg-lake-blue hidden md:flex">
                                        <span class="text-[10px] font-black uppercase opacity-60">Day</span>
                                        <span class="text-2xl font-black" x-text="day.day || (i + 1)"></span>
                                    </div>
                                    
                                    <div class="bg-white rounded-[2.5rem] p-10 md:p-12 shadow-2xl shadow-slate-200/50 border border-slate-50 transition-all duration-500 group-hover:border-lake-blue/20 group-hover:shadow-lake-blue/10">
                                        <div class="flex items-center gap-4 mb-6 md:hidden">
                                            <div class="w-12 h-12 rounded-2xl bg-lake-blue text-white flex items-center justify-center font-black">
                                                <span x-text="day.day || (i + 1)"></span>
                                            </div>
                                            <span class="text-xs font-black text-lake-blue uppercase tracking-widest">Agenda Hari Ini</span>
                                        </div>
                                        ...
                                        <template x-if="day.activities && day.activities.length > 0">
                                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                <template x-for="(act, j) in day.activities" :key="j">
                                                    <div class="flex items-center gap-4 p-4 bg-slate-50 rounded-2xl border border-transparent hover:border-lake-blue/20 transition-all">
                                                        <div class="w-2 h-2 bg-lake-blue rounded-full"></div>
                    ...
                    <div x-show="package.pricingDetails && package.pricingDetails.length > 0" class="bg-white rounded-[3rem] p-10 md:p-14 shadow-2xl shadow-slate-200/50 border border-slate-100">
                        <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-12 gap-6">
                            <div>
                                <div class="flex items-center space-x-3 mb-4">
                                    <div class="h-1.5 w-12 bg-lake-blue rounded-full"></div>
                                    <span class="text-lake-blue font-black text-xs uppercase tracking-[0.4em]">Rincian Biaya</span>
                                </div>
                                <h3 class="text-3xl font-black text-slate-900 tracking-tight">Investasi <span class="text-lake-blue">Perjalanan</span></h3>
                            </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
                            <template x-for="price in package.pricingDetails" :key="price.pax">
                                <div class="flex items-center justify-between p-8 bg-slate-50 rounded-[2rem] border border-transparent hover:border-lake-blue/20 transition-all group">
                                    <div class="flex items-center gap-5">
                                        <div class="w-14 h-14 rounded-2xl bg-white shadow-xl flex items-center justify-center text-lake-blue group-hover:bg-lake-blue group-hover:text-white transition-all">
                                    ...
                                    <div class="text-right">
                                        ...
                                        <p class="text-xl font-black text-lake-blue">
                                            <span x-text="formatPrice(price.price || price.price_per_person || price.pricePerPerson)"></span>
                                        </p>
                                    </div>
                                </div>
                            </template>
                        ...
                        <div class="p-8 bg-lake-blue/5 rounded-3xl border border-dashed border-lake-blue/30 flex items-start gap-6">
                            <div class="w-12 h-12 rounded-2xl bg-white shadow-lg flex items-center justify-center text-lake-blue shrink-0">
                ...
                <div x-show="activeTab === 'reviews'" x-transition:enter="transition ease-out duration-500" x-transition:enter-start="opacity-0 translate-y-8" x-transition:enter-end="opacity-100 translate-y-0">
                    <div class="bg-white rounded-[3rem] p-10 md:p-14 shadow-2xl shadow-slate-200/50 border border-slate-100">
                        ...
                        @if(!empty($testimonials))
                            <div class="mb-12">
                                <h3 class="text-3xl font-black text-slate-900 tracking-tight mb-2">Ulasan <span class="text-lake-blue">Pengunjung</span></h3>
                                <p class="text-slate-500 font-medium">Apa kata mereka yang telah menjelajahi Danau Toba bersama kami.</p>
                            </div>
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                                @foreach($testimonials as $t)
                                <div class="p-8 bg-slate-50 rounded-[2.5rem] border border-transparent hover:border-lake-blue/20 transition-all">
                                    <div class="flex items-center gap-4 mb-6">
                                        ...
                                        @else
                                            <div class="w-12 h-12 rounded-2xl bg-lake-blue/10 flex items-center justify-center text-lake-blue font-black text-xl">
                        ...
                        @else
                            ...
                            <div class="text-center py-16">
                                <div class="w-24 h-24 bg-lake-blue/5 rounded-full flex items-center justify-center mx-auto mb-8">
                                    <svg class="w-10 h-10 text-lake-blue/40" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"><path d="M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2h-5l-5 5v-5z"/></svg>
                                </div>
                                ...
                                <a :href="'https://wa.me/' + waNumber + '?text=' + encodeURIComponent('Halo Sujailake Toba, saya ingin berbagi pengalaman wisata bersama kalian 😊')" target="_blank"
                                   class="inline-flex items-center gap-3 bg-lake-blue text-white px-10 py-5 rounded-[2rem] font-black text-xs uppercase tracking-widest hover:bg-slate-900 transition-all duration-500 shadow-xl shadow-lake-blue/20">
            ...
            <div class="lg:col-span-4 relative">
                <div class="sticky top-28 space-y-8 animate-in fade-in slide-in-from-right-12 duration-1000">
                    ...
                    <div class="bg-slate-900 rounded-[3.5rem] p-10 md:p-12 text-white shadow-[0_50px_100px_-20px_rgba(15,23,42,0.4)] relative overflow-hidden">
                        <!-- Design elements -->
                        <div class="absolute -top-24 -right-24 w-64 h-64 bg-lake-blue/20 rounded-full blur-[80px]"></div>
                        <div class="absolute -bottom-24 -left-24 w-64 h-64 bg-toba-accent/10 rounded-full blur-[80px]"></div>
                        
                        <div class="relative z-10">
                            <span class="text-lake-light font-black text-[11px] uppercase tracking-[0.4em] mb-6 block">Reservasi Sekarang</span>
                            ...
                            <a
                                href="#booking-form"
                                class="w-full py-6 bg-lake-blue text-white rounded-[2rem] font-black text-sm uppercase tracking-[0.2em] hover:bg-white hover:text-slate-900 transition-all duration-500 shadow-2xl shadow-lake-blue/20 flex items-center justify-center gap-3 group"
                            >
                            ...
                            <a
                                :href="'https://wa.me/' + waNumber + '?text=' + encodeURIComponent('Halo Sujailake Toba, saya ingin bertanya tentang paket: *' + package.name + '*') "
                                target="_blank"
                                class="flex items-center justify-center gap-2 mt-4 text-lake-light font-black text-[10px] uppercase tracking-widest hover:text-white transition-colors"
                            >
                    ...
                    <div class="flex flex-col gap-4">
                        ...
                        <div class="bg-white rounded-[2.5rem] p-8 border border-slate-100 shadow-sm relative overflow-hidden group">
                            <div class="absolute top-0 right-0 w-24 h-24 bg-lake-blue/5 rounded-full -mr-12 -mt-12 group-hover:scale-150 transition-transform duration-700"></div>
                            <div class="flex items-center gap-4 mb-6 relative z-10">
                                <div class="w-12 h-12 rounded-full bg-slate-100 flex items-center justify-center text-lake-blue overflow-hidden border-2 border-white shadow-sm">
    ...
    <div class="max-w-7xl mx-auto px-6 md:px-8 mt-32 mb-20">
        <div class="flex items-end justify-between gap-6 mb-12">
            <div>
                <span class="text-lake-blue text-[11px] font-black uppercase tracking-[0.3em] mb-3 block">Rekomendasi</span>
                <h2 class="text-4xl font-black text-slate-900 tracking-tight">Paket Wisata <span class="text-lake-blue">Serupa</span></h2>
            </div>
            <a href="/packages" class="shrink-0 text-lake-blue font-black text-sm hover:underline flex items-center gap-2">
                Lihat Semua <i class="fas fa-arrow-right"></i>
            </a>
        </div>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            @foreach($relatedPackages as $rp)
            <a href="{{ route('tour.package.detail', $rp->slug) }}" class="group block bg-white rounded-[2rem] overflow-hidden border border-slate-100 hover:shadow-2xl transition-all duration-500">
                <div class="relative h-56 overflow-hidden">
                    <img src="{{ imageUrl($rp->images[0] ?? null) }}" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700">
                    <div class="absolute bottom-4 left-4">
                        <span class="px-3 py-1 bg-slate-900/80 backdrop-blur-md text-white text-[9px] font-black uppercase tracking-widest rounded-full">{{ $rp->duration }}</span>
                    </div>
                </div>
                <div class="p-6">
                    <h3 class="font-black text-slate-900 text-lg mb-2 group-hover:text-lake-blue transition-colors line-clamp-1">{{ $rp->name }}</h3>
                    <p class="text-lake-blue font-black">Rp {{ number_format($rp->price, 0, ',', '.') }}</p>
                </div>
            </a>
            @endforeach
        </div>
