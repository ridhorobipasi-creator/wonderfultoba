...
@section('title', 'Kebijakan Privasi – Sujailake Toba')
...
<div class="bg-slate-50 min-h-screen pt-32 pb-24">
    <div class="max-w-4xl mx-auto px-4">
        <div class="bg-white rounded-[3rem] p-8 md:p-16 shadow-sm border border-slate-100">
            <h1 class="text-3xl md:text-5xl font-black text-slate-900 mb-10">Kebijakan <span class="text-lake-blue">Privasi</span></h1>
            ...
            <div class="prose prose-slate max-w-none font-medium text-slate-600 leading-relaxed">
                ...
                @else
                    ...
                    <p class="mb-6">Sujailake Toba berkomitmen untuk melindungi privasi pelanggan kami. Kami hanya mengumpulkan informasi yang diperlukan untuk memproses pemesanan Anda dan meningkatkan layanan kami.</p>
                    
                    <h3 class="text-slate-900 font-black text-xl mb-4">Informasi yang Kami Kumpulkan</h3>
                    <p class="mb-6">Informasi yang kami kumpulkan meliputi nama, alamat email, nomor telepon, dan detail perjalanan yang diperlukan untuk koordinasi tour atau perjalanan wisata.</p>
