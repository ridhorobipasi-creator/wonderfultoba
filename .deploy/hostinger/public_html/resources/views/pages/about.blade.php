...
@section('title', 'Tentang Kami – Sujailake Toba')
@section('description', 'Sujailake Toba adalah provider perjalanan wisata dan outbound premium di Sumatera Utara yang berdedikasi memberikan pengalaman terbaik.')
...
<div class="bg-white min-h-screen pb-32">
        ...
        <div class="relative z-10 w-full max-w-7xl mx-auto px-6 md:px-8 pt-20">
            <div class="max-w-4xl animate-in fade-in slide-in-from-left-12 duration-1000">
                <div class="flex items-center space-x-3 mb-8">
                    ...
                    <span class="text-lake-light font-black text-xs uppercase tracking-[0.4em]">Our Legacy</span>
                </div>
                <h1 class="text-5xl md:text-8xl font-black text-white tracking-tighter leading-[0.9] mb-10">
                    Dedikasi Untuk <br />
                    <span class="text-lake-blue">Pariwisata Sumut</span>
                </h1>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24 items-center">
                <div class="lg:col-span-6 relative">
                    <div class="relative z-10 aspect-[4/5] rounded-[4rem] overflow-hidden shadow-2xl">
                        <img src="{{ imageUrl($content['image_url'] ?? '2026/04/sumatra-panorama.webp') }}" alt="Sujailake Toba Story" class="w-full h-full object-cover">
                    </div>
                    <!-- Decorative Element -->
                    <div class="absolute -bottom-12 -right-12 w-64 h-64 bg-lake-blue/10 rounded-full blur-3xl -z-10"></div>
                    ...
                    <div class="absolute -bottom-8 -left-8 bg-white p-8 rounded-[2.5rem] shadow-2xl border border-slate-50 hidden md:block max-w-sm">
                        ...
                        <p class="text-lake-blue font-bold text-xs uppercase tracking-widest">— {{ $content['testimonial_name'] ?? 'Pelanggan Setia' }}</p>
                    </div>
                </div>

                <div class="lg:col-span-6 space-y-10">
                    <div class="space-y-6">
                        <span class="text-lake-blue font-black text-xs uppercase tracking-[0.3em]">Mengenal Kami</span>
                        ...
                        <div class="text-lg text-slate-600 font-medium leading-relaxed space-y-6">
                            {!! nl2br(e($content['description'] ?? 'Berawal dari kecintaan terhadap keindahan alam Sumatera Utara, Sujailake Toba hadir untuk memberikan pengalaman perjalanan yang tak terlupakan bagi setiap wisatawan. Kami percaya bahwa setiap perjalanan memiliki cerita unik yang layak untuk dikenang selamanya.')) !!}
                        </div>
                    </div>

                    <div class="grid grid-cols-2 gap-10 pt-10 border-t border-slate-100">
                        <div>
                            <p class="text-5xl font-black text-lake-blue mb-2 tracking-tighter">{{ $content['stat_years'] ?? '12+' }}</p>
                            <p class="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]">{{ $content['stat_years_label'] ?? 'Tahun Pengalaman' }}</p>
                        </div>
                        <div>
                            <p class="text-5xl font-black text-lake-blue mb-2 tracking-tighter">{{ $content['stat_tourists'] ?? '5K+' }}</p>
    ...
    <section class="py-24 md:py-40 bg-slate-50 relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-6 md:px-8 relative z-10">
            <div class="text-center max-w-3xl mx-auto mb-20 md:mb-32">
                <span class="text-lake-blue font-black text-xs uppercase tracking-[0.3em] mb-6 block">Our Purpose</span>
                <h2 class="text-4xl md:text-6xl font-black text-slate-900 tracking-tight leading-tight">
                    Visi & Misi <span class="text-lake-blue">Masa Depan</span>
                </h2>
            </div>

            <div class="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16">
                <!-- Vision Card -->
                <div class="group bg-white p-12 md:p-16 rounded-[4rem] shadow-2xl shadow-slate-200/50 border border-transparent hover:border-lake-blue/20 transition-all duration-700">
                    <div class="w-20 h-20 bg-lake-blue rounded-[1.5rem] flex items-center justify-center text-white mb-10 shadow-xl shadow-lake-blue/30 group-hover:scale-110 transition-transform duration-500">
                    ...
                    <ul class="space-y-6">
                        ...
                        @foreach($missions as $mission)
                            ...
                            <li class="flex items-start gap-4">
                                <div class="w-6 h-6 rounded-full bg-lake-blue/10 text-lake-blue flex items-center justify-center shrink-0 mt-1">
        ...
        <div class="max-w-7xl mx-auto px-6 md:px-8">
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
                <div class="lg:col-span-5">
                    <span class="text-lake-blue font-black text-xs uppercase tracking-[0.3em] mb-6 block">Why Us</span>
                    <h2 class="text-4xl md:text-6xl font-black text-slate-900 tracking-tight leading-tight mb-10">
                        Keunggulan <br /> <span class="text-lake-blue">Sujailake Toba</span>
                    </h2>
                    ...
                    <a href="{{ route('tour.packages') }}" class="inline-flex items-center gap-4 py-5 px-10 bg-slate-900 text-white rounded-2xl font-black text-xs uppercase tracking-widest hover:bg-lake-blue transition-all shadow-xl group">
                        Lihat Layanan Kami
                ...
                <div class="lg:col-span-7">
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-8">
                        <div class="p-10 bg-white rounded-[3rem] border border-slate-100 shadow-xl shadow-slate-200/30 hover:shadow-lake-blue/10 transition-all group">
                            <div class="w-14 h-14 bg-slate-50 rounded-2xl flex items-center justify-center text-lake-blue mb-8 group-hover:bg-lake-blue group-hover:text-white transition-all">
    ...
    <section class="py-24 bg-slate-900 overflow-hidden">
        <div class="max-w-7xl mx-auto px-6 md:px-8">
            <div class="text-center mb-16">
                <span class="text-lake-light font-black text-[10px] uppercase tracking-[0.4em] mb-4 block">Official Partners</span>
    ...
    <section class="py-24 md:py-32 px-6 md:px-8">
        <div class="max-w-7xl mx-auto bg-slate-100 rounded-[4rem] p-12 md:p-24 relative overflow-hidden text-center">
            <div class="absolute -top-24 -right-24 w-96 h-96 bg-lake-blue/5 rounded-full blur-3xl"></div>
            ...
            <div class="relative z-10 max-w-3xl mx-auto">
                <h2 class="text-4xl md:text-7xl font-black text-slate-900 mb-8 tracking-tighter leading-tight">
                    Mulai Cerita <br /> <span class="text-lake-blue">Anda Bersama Kami</span>
                </h2>
                <p class="text-lg text-slate-500 font-medium leading-relaxed mb-12">
                ...
                <div class="flex flex-col sm:flex-row items-center justify-center gap-6">
                    <a href="{{ route('tour.packages') }}" class="px-12 py-6 bg-lake-blue text-white rounded-[2rem] font-black text-sm uppercase tracking-widest hover:bg-slate-900 transition-all shadow-2xl shadow-lake-blue/30">
                        Pilih Paket Wisata
                    </a>
