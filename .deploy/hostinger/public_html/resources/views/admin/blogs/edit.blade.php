...
@section('title', 'Edit Artikel Mandiri - Sujailake Toba')
                ...
                <div class="bg-slate-50 p-8 md:p-16 rounded-[3.5rem] border border-slate-100 min-h-[900px] flex justify-center relative">
                    <div class="w-full max-w-[800px] bg-white shadow-2xl rounded-sm p-16 md:p-24 min-h-[1000px] relative">
                        ...
                        <div id="editor-container" class="prose prose-slate max-w-none">
                            <textarea name="content" id="editor" rows="20" class="w-full px-6 py-4 bg-slate-50 border-none rounded-[2rem] font-medium text-sm leading-relaxed focus:ring-2 focus:ring-lake-blue transition-all">{{ old('content', $blog->content) }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="xl:col-span-4 space-y-8">
                ...
                <div class="bg-white rounded-[2.5rem] p-8 shadow-sm border border-slate-100">
                    ...
                    <div class="space-y-4">
                        ...
                        <input type="text" name="author" value="{{ old('author', $blog->author) }}" class="w-full px-6 py-4 bg-slate-50 border-none rounded-2xl focus:ring-2 focus:ring-emerald-500/20 text-xs font-bold text-slate-600">
                    </div>
                </div>
                ...
                <div class="bg-white rounded-[2.5rem] p-8 shadow-sm border border-slate-100">
                    ...
                    <textarea name="excerpt" rows="4" placeholder="Tuliskan teaser artikel..."
                        class="w-full px-6 py-5 bg-slate-50 border-none rounded-2xl focus:ring-2 focus:ring-emerald-500/20 text-xs font-medium text-slate-500 leading-relaxed">{{ old('excerpt', $blog->excerpt) }}</textarea>
                </div>
