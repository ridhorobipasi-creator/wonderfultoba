...
@section('title', 'Editor Artikel Mandiri - Sujailake Toba')
                ...
                <div class="bg-slate-50 p-8 md:p-16 rounded-[3.5rem] border border-slate-100 min-h-[900px] flex justify-center relative">
                    <div class="w-full max-w-[800px] bg-white shadow-2xl rounded-sm p-16 md:p-24 min-h-[1000px] relative">
                        ...
                        <div id="editor-container" class="prose prose-slate max-w-none">
                            <textarea name="content" id="editor" rows="20" class="w-full px-6 py-4 bg-slate-50 border-none rounded-[2rem] font-medium text-sm leading-relaxed focus:ring-2 focus:ring-lake-blue transition-all">{{ old('content') }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
