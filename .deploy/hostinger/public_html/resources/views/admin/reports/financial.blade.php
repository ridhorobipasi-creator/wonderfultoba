...
@section('title', 'Laporan Keuangan - Sujailake Toba')
...
<div class="space-y-6">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <form action="{{ route('admin.reports.financial') }}" method="GET" class="flex items-center gap-2">
            ...
            <button type="submit" class="p-2 bg-lake-blue text-white rounded-xl hover:bg-lake-blue/90 transition shadow-lg shadow-lake-blue/20">
        ...
        <div class="lg:col-span-1 bg-white p-8 rounded-[2.5rem] border border-slate-100 shadow-sm">
                    ...
                    <div class="flex-1 flex flex-col items-center gap-2 group h-full justify-end">
                        <div class="w-full bg-indigo-100/50 group-hover:bg-indigo-200 rounded-t-lg transition-all relative overflow-hidden" 
                            ...
                            @if($month !== 'all' && $m == $month)
                                <div class="absolute inset-0 bg-lake-blue shadow-[0_0_15px_rgba(16,185,129,0.5)]"></div>
                            @endif
                        </div>
            ...
            <div class="mt-8 pt-6 border-t border-slate-50 flex items-center justify-between">
                ...
                <div class="text-right">
                    ...
                    <p class="text-lg font-black text-lake-blue">{{ $month === 'all' ? array_sum($monthlyChart) : $monthlyChart[$month] }}</p>
                </div>
            </div>
        </div>
