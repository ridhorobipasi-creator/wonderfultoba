...
@section('title', 'Edit Armada: ' . $car->name)
            ...
            <div class="lg:col-span-8 space-y-8">
                <div class="bg-white rounded-[2.5rem] border border-slate-100 shadow-sm p-8 md:p-10 space-y-8">
                    <div class="flex items-center gap-4 mb-2">
                        ...
                        <div>
                            <h2 class="text-xl font-black text-slate-900 tracking-tight">Edit Detail Kendaraan</h2>
                            <p class="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Perbarui informasi armada mobil.</p>
                        </div>
                    </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" name="type" value="{{ old('type', $car->type) }}" required 
                                       class="w-full px-6 py-4 bg-slate-50 border-none rounded-2xl focus:ring-2 focus:ring-toba-green/20 font-bold text-slate-900 placeholder:text-slate-300 transition-all"
                            ...
                            <div>
                                ...
                                <select name="status" required 
                                    ...
                                    <option value="active" {{ $car->status === 'active' ? 'selected' : '' }}>Tersedia (Aktif)</option>
                                    <option value="inactive" {{ $car->status === 'inactive' ? 'selected' : '' }}>Tidak Tersedia (Maintenance)</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div>
                                ...
                                <div class="relative">
                                    <input type="number" name="capacity" value="{{ old('capacity', $car->capacity) }}" required 
                                           class="w-full px-6 py-4 bg-slate-50 border-none rounded-2xl focus:ring-2 focus:ring-toba-green/20 font-bold text-slate-900 transition-all">
                            ...
                            <div>
                                ...
                                <select name="transmission" required 
                                    ...
                                    <option value="automatic" {{ $car->transmission === 'automatic' ? 'selected' : '' }}>Matic</option>
                                </select>
                            </div>
                            <div>
                                <label class="block text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] mb-3 ml-1">Bahan Bakar</label>
                                <input type="text" name="fuel" value="{{ old('fuel', $car->fuel) }}" required 
                                       class="w-full px-6 py-4 bg-slate-50 border-none rounded-2xl focus:ring-2 focus:ring-toba-green/20 font-bold text-slate-900 transition-all">
                            </div>
                        </div>
                    </div>
                ...
                <div class="bg-white rounded-[2.5rem] border border-slate-100 shadow-sm p-8 md:p-10 space-y-8">
                    <div class="flex items-center justify-between gap-4">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Kelola foto unit ini.</p>
                            </div>
                        </div>
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                        ...
                        <button type="button" @click="openMediaPicker()"
                            ...
                            <i class="fas fa-plus text-slate-200 group-hover:text-toba-green text-xl transition-colors"></i>
                        </button>
                    </div>
                </div>
            </div>
                ...
                <div class="bg-white rounded-[2.5rem] border border-slate-100 shadow-sm p-8 space-y-8 sticky top-24">
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <span class="absolute left-6 top-1/2 -translate-y-1/2 text-sm font-black text-slate-400">Rp</span>
                                <input type="number" name="priceWithDriver" value="{{ old('priceWithDriver', $car->priceWithDriver) }}"
                        ...
                        <div class="pt-6 border-t border-slate-50">
                            <label class="flex items-center gap-3 cursor-pointer group">
                                <div class="relative">
                                    <input type="checkbox" name="isFeatured" value="1" {{ $car->isFeatured ? 'checked' : '' }} class="sr-only peer">
